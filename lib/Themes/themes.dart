...
extension ThemeExtension on ThemeData {
  ...
  TextStyle get kBigTextStyle => const TextStyle(
      fontFamily: 'Supria Sans', fontWeight: FontWeight.w800, fontSize: 40);
  TextStyle get kMedTextStyle => const TextStyle(
      fontFamily: 'Supria Sans', fontWeight: FontWeight.w800, fontSize: 30);
  TextStyle get kTitleTextStyle => TextStyle(
      fontFamily: 'Supria Sans',
      fontWeight: FontWeight.w800,
      color: btnTextCol,
      fontSize: 25);
  TextStyle get kSubTitleTextStyle => const TextStyle(
      fontFamily: 'Supria Sans', fontSize: 17, fontWeight: FontWeight.w300);
  TextStyle get kNormalTextStyle => const TextStyle(
      fontFamily: 'Supria Sans', fontSize: 20, fontWeight: FontWeight.w700);
